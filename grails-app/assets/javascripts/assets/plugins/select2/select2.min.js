    ...
    if (window.Select2 === t) {
        ...
        P = e(document), D = function () {
            ...
            bind: function (e) {
                ...
                }))), "function" != typeof i.query) console.log("query function not defined for Select2 " + i.element.attr("id"));
                return i
                ...
                var t, i, n, a, r = this.dropdown, o = this.container.offset(), s = this.container.outerHeight(!1),
                    l = r.outerHeight(!1), d = e(window).scrollLeft() + e(window).width(),
                    h = e(window).scrollTop() + e(window).height(), c = o.top + s, u = o.left, p = h >= c + l,
                    g = o.top - l >= this.body().scrollTop(), f = r.outerWidth(!1), m = d >= u + f,
                ...
                var e, t = this.results, i = t.find("li.select2-more-results"), n = this.resultsPage + 1, a = this,
                    r = this.search.val(), o = this.context;
                ...
                var o, s, l, d = this.search, h = this.results, c = this.opts, u = this, p = d.val(),
                ...
                var t = this.highlight(), i = this.results.find(".select2-highlighted"),
            ...
            createContainer: function () {
                ...
                this.selection.on("click", ".select2-search-choice:not(.select2-locked)", function () {
                    ...
                    if (this.isInterfaceEnabled()) {
                        ...
                        var i = t.find(".select2-search-choice-focus"),
                            ...
                            a = i.next(".select2-search-choice:not(.select2-locked)"), r = g(this.search);
                ...
                var n, a, r = !i.locked,
                    ...
                    s = e("<li class='select2-search-choice select2-locked'><div></div></li>"), l = r ? o : s,
                    d = this.id(i), h = this.getVal();
                ...
                var a = this.getVal(), r = this.results.find(".select2-result"),
            ...
            var i, a, r, o, s, l = Array.prototype.slice.call(arguments, 0),
                ...
                h = ["opened", "isFocused", "container", "dropdown"], c = ["val", "data"],
