...
class LoginController extends grails.plugin.springsecurity.LoginController implements GrailsConfigurationAware {
	...
	def auth = {
		...
		def config =  getConf() // SpringSecurityUtils.securityConfig

		if (springSecurityService.isLoggedIn()) {
			redirect uri: config.successHandler.defaultTargetUrl
			return
		} 
//		println "fullName"+springSecurityService.principal["dn"].class.name
		String view = 'auth'
...
//		}
	...
	@Override
	void setRequestDataValueProcessor(org.springframework.web.servlet.support.RequestDataValueProcessor requestDataValueProcessor) {

	}

	@Override
	void setGroovyPageLayoutFinder(org.grails.web.sitemesh.GroovyPageLayoutFinder groovyPageLayoutFinder) {
